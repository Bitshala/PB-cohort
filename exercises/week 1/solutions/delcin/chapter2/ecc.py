...
class Point:
    ...
    def __init__(self, x, y, a, b):
        ...
        if self.x is None or self.y is None:
            raise ValueError('Invalid: exactly one of x or y are None')
        # end::source2[]
        # tag::source1[]
    ...
    def __add__(self, other):  # <2>
        ...
        if self.x != other.x:
            m = (self.y - other.y) / (self.x - other.x) # slope
            x3 = m**2 - self.x - other.x
            return Point(x3, (m * (self.x - x3)) - self.y, self.a, self.b)  
