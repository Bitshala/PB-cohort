...
# Get the absolute path to the directory containing chapter1.py
chapter1_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'chapter1'))

# Add the chapter1 directory to the Python path
sys.path.append(chapter1_dir)

# Now you should be able to import FieldElement
from chapter1 import FieldElement
