...
class Tx:
    ...
    def parse(cls, s, testnet=False):
        ...
        version = little_endian_to_int(txbytes)
...
# ersion, tx_ins, tx_outs, locktime, testnet=False):
...
class TxIn:
    ...
    def parse(cls, s):
        ...
        # return an instance of the class (see __init__ for args)
        # print(f"{prev_tx}--{prev_index}--{script_sig}--{sequence}")
...
class TxTest(TestCase):
    cache_file = '/home/lol/pb-cohort/exercises/week 3/solutions/sahil-tgs/chapter5/tx.cache'
