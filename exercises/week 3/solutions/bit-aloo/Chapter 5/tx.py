...
class Tx:
    ...
    def parse(cls, s, testnet=False):
        ...
        parsed_version = little_endian_to_int(s.read(4))
        ...
        return cls(parsed_version,inputs,outputs,locktime,testnet=testnet)
    ...
    def fee(self):
        ...
        for x in self.tx_ins: 
            sum += x.value(testnet=False)
        for x in self.tx_outs:
            sum -= x.amount
