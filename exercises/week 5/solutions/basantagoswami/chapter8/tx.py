...
class Tx:
    ...
    def sig_hash(self, input_index, redeem_script=None):
        ...
        for i, tx_in in enumerate(self.tx_ins):
            ...
            if i == input_index:
                ...
                script_sig = redeem_script if redeem_script else tx_in.script_pubkey(self.testnet)
    ...
    def verify_input(self, input_index):
        ...
        if script_pubkey.is_p2sh_script_pubkey():
            ...
            parsed_redeem_script = Script.parse(BytesIO(redeem_script))
        # otherwise RedeemScript is None
        else:
            parsed_redeem_script = None
        # get the signature hash (z)
        # pass the RedeemScript to the sig_hash method
        z = self.sig_hash(input_index, parsed_redeem_script)
