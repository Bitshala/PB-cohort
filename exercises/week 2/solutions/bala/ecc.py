...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for i in additions:
            x1=FieldElement(i[0],prime)
            y1=FieldElement(i[1],prime)
            x2=FieldElement(i[2],prime)
            y2=FieldElement(i[3],prime)
            x3=FieldElement(i[4],prime)
            y3=FieldElement(i[5],prime)
            p1=Point(x1,y1,a,b)
            p2=Point(x2,y2,a,b)
            p3=Point(x3,y3,a,b)
