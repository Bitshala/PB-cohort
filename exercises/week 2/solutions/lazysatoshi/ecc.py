...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        # check p1+p2==p3
        for sx1, sy1, sx2, sy2, sx3, sy3 in additions:
            x1 = FieldElement(sx1, prime)
            x2 = FieldElement(sx2, prime)
            x3 = FieldElement(sx3, prime)
            y1 = FieldElement(sy1, prime)
            y2 = FieldElement(sy2, prime)
            y3 = FieldElement(sy3, prime)
            p1 = Point(x1, y1, a, b)
            p2 = Point(x2, y2, a, b)
            p3 = Point(x3, y3, a, b)
