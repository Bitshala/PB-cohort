...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for coordinate in additions:
            x1 = FieldElement(num=additions[0][0], prime=prime)
            y1 = FieldElement(num=additions[0][1], prime=prime)           
            x2 = FieldElement(num=additions[0][2], prime=prime)
            y2 = FieldElement(num=additions[0][3], prime=prime)
            x3 = FieldElement(num=additions[0][4], prime=prime)
            y3 = FieldElement(num=additions[0][5], prime=prime)
            p1 = Point(x1, y1, a, b)
            p2 = Point(x2, y2, a, b)
            p3 = Point(x3, y3, a, b)
            return p1+p2 == p3
